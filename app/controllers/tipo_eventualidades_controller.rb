  ...
  def create
    ...
    respond_to do |format|
      if @tipo_eventualidad.save
        format.html { redirect_to @tipo_eventualidad, notice: 'Tipo eventualidad was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @tipo_eventualidad.update(tipo_eventualidad_params)
        format.html { redirect_to @tipo_eventualidad, notice: 'Tipo eventualidad was successfully updated.' }
