  ...
  def create
    ...
    respond_to do |format|
      if @tipo_horario.save
        format.html { redirect_to @tipo_horario, notice: 'Tipo horario was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @tipo_horario.update(tipo_horario_params)
        format.html { redirect_to @tipo_horario, notice: 'Tipo horario was successfully updated.' }
