...
#   Tipo Horario linea 390 falta agregar con los cambios que tiene marcos
    ...
    Especialidad.find_or_create_by(descripcion: 'Intestino grueso', estatus: 1, :tipo_especialidad_id => 24)
    Especialidad.find_or_create_by(descripcion: 'Rinitis', estatus: 1, :tipo_especialidad_id => 14)
    Especialidad.find_or_create_by(descripcion: 'Quemaduras de segundo grado', estatus: 1, :tipo_especialidad_id => 22)
    Especialidad.find_or_create_by(descripcion: 'Cardiologia severa', estatus: 1, :tipo_especialidad_id => 8)
    ...
    Eventualidad.find_or_create_by(:descripcion => 'Cierre de la clinica', :estatus => 1, :tipo_eventualidad_id => 1, :motivo_id => Motivo.find(3), fecha_inicio: '01/03/2017', fecha_fin: '01/03/2017')
    Eventualidad.find_or_create_by(:descripcion => 'Cancelacion de cita', :estatus => 1, :tipo_eventualidad_id => 3, :motivo_id => Motivo.find(2), fecha_inicio: '01/03/2017', fecha_fin: '01/03/2017')
    ...
    Usuario.find_or_create_by(:email => 'jonnathangte68@hotmail.com', :encrypted_password => '$2a$04$WdGflFc08MtXWLskfoWM8.v8OsFDgM3bttyd4ZxTk2uRS3uZvr6ky', :rol_id => Rol.find(1), :persona => Persona.find(2))
    ...
    Horario.find_or_create_by(:tiempo_cita => 2, estatus: 1, :tipo_horario_id => 2, :servicio_id => Servicio.find(1))
    Horario.find_or_create_by(:tiempo_cita => 2, estatus: 1, :tipo_horario_id => 2, :servicio_id => Servicio.find(1))
    Horario.find_or_create_by(:tiempo_cita => 2, estatus: 1, :tipo_horario_id => 2, :servicio_id => Servicio.find(1))
    ...
    Cita.find_or_create_by(:turno => Turno.find(1), :persona => Persona.find(4), :usuario_id => nil, :fecha => '2016-09-12 00:00:00', :tipo_pago_id => TipoPago.find(1), :eventualidad_id => nil, estatus: 1)
    Cita.find_or_create_by(:turno => Turno.find(1), :persona => Persona.find(5), :usuario_id => nil, :fecha => '2016-09-12 00:00:00', :tipo_pago_id => TipoPago.find(1), :eventualidad_id => nil, estatus: 1)
    Cita.find_or_create_by(:turno => Turno.find(1), :persona => Persona.find(6), :usuario_id => nil, :fecha => '2016-09-12 00:00:00', :tipo_pago_id => TipoPago.find(2), :eventualidad_id => Eventualidad.find(2), estatus: 1)
    Cita.find_or_create_by(:turno => Turno.find(4), :persona => Persona.find(7), :usuario_id => nil, :fecha => '2016-09-12 00:00:00', :tipo_pago_id => TipoPago.find(1), :eventualidad_id => nil, estatus: 1)
    Cita.find_or_create_by(:turno => Turno.find(4), :persona => Persona.find(8), :usuario_id => nil, :fecha => '2016-09-12 00:00:00', :tipo_pago_id => TipoPago.find(3), :eventualidad_id => nil, estatus: 1)
    Cita.find_or_create_by(:turno => Turno.find(4), :persona => Persona.find(9), :usuario_id => nil, :fecha => '2016-09-12 00:00:00', :tipo_pago_id => TipoPago.find(5), :eventualidad_id => nil, estatus: 1)
    Cita.find_or_create_by(:turno => Turno.find(4), :persona => Persona.find(10), :usuario_id => nil, :fecha => '2016-09-12 00:00:00', :tipo_pago_id => TipoPago.find(2), :eventualidad_id => nil, estatus: 1)
    Cita.find_or_create_by(:turno => Turno.find(4), :persona => Persona.find(11), :usuario_id => nil, :fecha => '2016-09-12 00:00:00', :tipo_pago_id => TipoPago.find(1), :eventualidad_id => nil, estatus: 1)
    Cita.find_or_create_by(:turno => Turno.find(4), :persona => Persona.find(12), :usuario_id => nil, :fecha => '2016-09-12 00:00:00', :tipo_pago_id => TipoPago.find(4), :eventualidad_id => nil, estatus: 1)
