...
#   Tipo Horario linea 390 falta agregar con los cambios que tiene marcos
    ...
    Cita.find_or_create_by(:turno => Turno.find(4), :persona => Persona.find(9), :usuario_id => nil, :fecha => '13/09/2016', :tipo_pago_id => TipoPago.find(1), :eventualidad_id => nil, estatus: 1)
	...
	OptionMenu.find_or_create_by(:id_padre => nil, :nombre => 'Configuración General',     :url_path => '#', :icono => 'fa-cogs'       ,      :controlador => '', :accion => '', num_hijos: 3, :estatus => 'A')
    	...
    	OptionMenu.find_or_create_by(:id_padre => 1,   :nombre => 'Datos de Segmentación',                   :url_path => '#', :icono => 'fa-edit',          :controlador => '', :accion => '', num_hijos: 21, :estatus => 'A')
          	OptionMenu.find_or_create_by(:id_padre => 27, :nombre => 'Tipos de Adicción',                   :url_path => '/tipo_adicciones', :icono => '',             :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
	        OptionMenu.find_or_create_by(:id_padre => 27, :nombre => 'Adicciones',                   :url_path => '/adicciones', :icono => '',             :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
	        OptionMenu.find_or_create_by(:id_padre => 27, :nombre => 'Tipos de Cirugía',                   :url_path => '/tipo_cirugias', :icono => '',             :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
	        OptionMenu.find_or_create_by(:id_padre => 27, :nombre => 'Cirugías',                   :url_path => '/cirugias', :icono => '',             :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
	        OptionMenu.find_or_create_by(:id_padre => 27, :nombre => 'Tipos de Discapacidad',                   :url_path => '/tipo_discapacidades', :icono => '',             :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
	        OptionMenu.find_or_create_by(:id_padre => 27, :nombre => 'Discapacidades',                   :url_path => '/discapacidades', :icono => '',             :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
	        OptionMenu.find_or_create_by(:id_padre => 27, :nombre => 'Estado Civil',                   :url_path => '/estado_civiles', :icono => '',             :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
	        OptionMenu.find_or_create_by(:id_padre => 27, :nombre => 'Grupos Sanguíneos',                   :url_path => '/grupo_sanguineos', :icono => '',             :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
	        OptionMenu.find_or_create_by(:id_padre => 27, :nombre => 'Tipos de Hábito',                   :url_path => '/tipo_habitos', :icono => '',             :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
	        OptionMenu.find_or_create_by(:id_padre => 27, :nombre => 'Hábitos',                   :url_path => '/habitos', :icono => '',             :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
	        OptionMenu.find_or_create_by(:id_padre => 27, :nombre => 'Tipos de Lesión',                   :url_path => '/tipo_lesiones', :icono => '',             :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
	        OptionMenu.find_or_create_by(:id_padre => 27, :nombre => 'Lesiones',                   :url_path => '/lesiones', :icono => '',             :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
	        OptionMenu.find_or_create_by(:id_padre => 27, :nombre => 'Ocupaciones',                   :url_path => '/ocupaciones', :icono => '',             :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
	        OptionMenu.find_or_create_by(:id_padre => 27, :nombre => 'Tipos de Parentesco',                   :url_path => '/tipo_parentescos', :icono => '',             :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
	        OptionMenu.find_or_create_by(:id_padre => 27, :nombre => 'Tipos de Patologías',                   :url_path => '/tipo_patologias', :icono => '',             :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
	        OptionMenu.find_or_create_by(:id_padre => 27, :nombre => 'Patologías',                   :url_path => '/patologias', :icono => '',             :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
	        OptionMenu.find_or_create_by(:id_padre => 27, :nombre => 'Profesiones',                   :url_path => '/profesiones', :icono => '',             :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
	        OptionMenu.find_or_create_by(:id_padre => 27, :nombre => 'Rangos de Edad',                   :url_path => '/rango_edades', :icono => '',             :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
	        OptionMenu.find_or_create_by(:id_padre => 27, :nombre => 'Rangos de Peso',                   :url_path => '/rango_pesos', :icono => '',             :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
	        OptionMenu.find_or_create_by(:id_padre => 27, :nombre => 'Sexo',                   :url_path => '/sexos', :icono => '',             :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
	        OptionMenu.find_or_create_by(:id_padre => 27, :nombre => 'Vacunas',                   :url_path => '/vacunas', :icono => '',             :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
	        OptionMenu.find_or_create_by(:id_padre => 27, :nombre => 'Perfiles',                   :url_path => '/perfiles',:icono => '',             :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
    OptionMenu.find_or_create_by(:id_padre => nil, :nombre => 'Servicios y Eventos',          :url_path => '#', :icono => 'fa-calendar',         :controlador => '', :accion => '', num_hijos: 2, :estatus => 'A')
		OptionMenu.find_or_create_by(:id_padre => 50,   :nombre => 'Catálogo de Servicios',   :url_path => '#', :icono => 'fa-table',           :controlador => '', :accion => '', num_hijos: 2, :estatus => 'A')
  		...
  		OptionMenu.find_or_create_by(:id_padre => 50,   :nombre => 'Catálogo de Eventos',     :url_path => '/eventos', :icono => 'fa-table',            :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
    ...
    OptionMenu.find_or_create_by(:id_padre => nil,   :nombre => 'Agenda',                  :url_path => '#', :icono => 'fa-calendar',         :controlador => '', :accion => '', num_hijos: 3, :estatus => 'A')
	    OptionMenu.find_or_create_by(:id_padre => 55,  :nombre => 'Mi Horario',               :url_path => '/horarios/1', :icono => 'fa-search',           :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
  	...
  	OptionMenu.find_or_create_by(:id_padre => nil, :nombre => 'Citas',                     :url_path => '#', :icono => 'fa-stethoscope',      :controlador => '', :accion => '', num_hijos: 4, :estatus => 'A')
        OptionMenu.find_or_create_by(:id_padre => 59,   :nombre => 'Mis Citas',              :url_path => '/citas', :icono => 'fa-search',           :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
    	OptionMenu.find_or_create_by(:id_padre => 59,   :nombre => 'Historial',              :url_path => '/historial_cita', :icono => 'fa-history',          :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
    ...
    OptionMenu.find_or_create_by(:id_padre => nil,   :nombre => 'Servicios Médicos',    :url_path => '#', :icono => 'fa-hospital-o', :controlador => '', :accion => '', num_hijos: 3, :estatus => 'A')
        OptionMenu.find_or_create_by(:id_padre => 62,   :nombre => 'Confirmar Cita',    :url_path => '/chequear_cita', :icono => 'fa-id-card-o', :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
