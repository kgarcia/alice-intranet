...
#   Tipo Horario linea 390 falta agregar con los cambios que tiene marcos
    ...
    Horario.find_or_create_by(:tiempo_cita => 2, estatus: 1, :tipo_horario_id => TipoHorario.find(2), :servicio_id => Servicio.find(1))
    Horario.find_or_create_by(:tiempo_cita => 2, estatus: 1, :tipo_horario_id => TipoHorario.find(2), :servicio_id => Servicio.find(1))
    TipoCita.find_or_create_by(descripcion: 'Normal', estatus: 1)
    TipoCita.find_or_create_by(descripcion: 'Urgente', estatus: 1)
    TipoCita.find_or_create_by(descripcion: 'Planificada', estatus: 1)
    TipoCita.find_or_create_by(descripcion: 'No planificada', estatus: 1)
    ...
    Cita.find_or_create_by(:turno => Turno.find(1), :persona_id => Persona.find(4), :usuario_id => nil, :fecha => '12/09/2016', :tipo_pago_id => TipoPago.find(1), :tipo_cita_id => TipoCita.find(1), :eventualidad_id => nil, estatus: 1)
    Cita.find_or_create_by(:turno => Turno.find(1), :persona_id => Persona.find(5), :usuario_id => nil, :fecha => '12/09/2016', :tipo_pago_id => TipoPago.find(1), :tipo_cita_id => TipoCita.find(2), :eventualidad_id => nil, estatus: 1)
    Cita.find_or_create_by(:turno => Turno.find(1), :persona_id => Persona.find(6), :usuario_id => nil, :fecha => '12/09/2016', :tipo_pago_id => TipoPago.find(2), :tipo_cita_id => TipoCita.find(1), :eventualidad_id => Eventualidad.find(2), estatus: 1)
