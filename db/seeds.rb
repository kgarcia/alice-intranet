...
#   Tipo Horario linea 390 falta agregar con los cambios que tiene marcos
    ...
    Especialidad.find_or_create_by(descripcion: 'Intestino grueso', estatus: 1, :tipo_especialidad_id => TipoEspecialidad.find(24))
    Especialidad.find_or_create_by(descripcion: 'Rinitis', estatus: 1, :tipo_especialidad_id => TipoEspecialidad.find(14))
    Especialidad.find_or_create_by(descripcion: 'Quemaduras de segundo grado', estatus: 1, :tipo_especialidad_id => TipoEspecialidad.find(22))
    Especialidad.find_or_create_by(descripcion: 'Cardiologia severa', estatus: 1, :tipo_especialidad_id => TipoEspecialidad.find(8))
    ...
    Especialista.find_or_create_by(:especialidad => Especialidad.find(4), :persona => Persona.find(1), estatus: 1)
    Especialista.find_or_create_by(:especialidad => Especialidad.find(1), :persona => Persona.find(2), estatus: 1)
    Especialista.find_or_create_by(:especialidad => Especialidad.find(3), :persona => Persona.find(3), estatus: 1)
