...
#   Tipo Horario linea 390 falta agregar con los cambios que tiene marcos
	...
	Adiccion.find_or_create_by(descripcion: 'Fumar',estatus: 1)
	Adiccion.find_or_create_by(descripcion: 'Comer en Exceso',estatus: 1)
	Adiccion.find_or_create_by(descripcion: 'Alcohol',estatus: 1)
	Adiccion.find_or_create_by(descripcion: 'Cafe',estatus: 1)
	Adiccion.find_or_create_by(descripcion: 'Drogas',estatus: 1)
	Adiccion.find_or_create_by(descripcion: 'Gaseosas',estatus: 1)
	Adiccion.find_or_create_by(descripcion: 'Actividad Sexual',estatus: 1)
    ...
    Discapacidad.find_or_create_by(descripcion: 'Vision Borrosa',estatus: 1, :tipo_discapacidad => TipoDiscapacidad.find(10))
    Especialidad.find_or_create_by(descripcion: 'Pediatria',estatus: 1)
    Especialidad.find_or_create_by(descripcion: 'Geriatria',estatus: 1)
    Especialidad.find_or_create_by(descripcion: 'Neumologia',estatus: 1)
    Especialidad.find_or_create_by(descripcion: 'Oftalmologia',estatus: 1)
    Especialidad.find_or_create_by(descripcion: 'Otorrinolaringologia',estatus: 1)
    Especialidad.find_or_create_by(descripcion: 'Radiologia',estatus: 1)
    Especialidad.find_or_create_by(descripcion: 'Microbiologia',estatus: 1)
    Especialidad.find_or_create_by(descripcion: 'Farmacologia',estatus: 1)
    Especialidad.find_or_create_by(descripcion: 'Cirugia',estatus: 1)
    Especialidad.find_or_create_by(descripcion: 'Ortopedia',estatus: 1)
    Especialidad.find_or_create_by(descripcion: 'Traumatologia',estatus: 1)
    Especialidad.find_or_create_by(descripcion: 'Rehabilitacion',estatus: 1)
    Especialidad.find_or_create_by(descripcion: 'Hidrologia',estatus: 1)
    Especialidad.find_or_create_by(descripcion: 'Infectologia',estatus: 1)
    Especialidad.find_or_create_by(descripcion: 'Alergologia',estatus: 1)
    Especialidad.find_or_create_by(descripcion: 'Psiquiatria',estatus: 1)
    Especialidad.find_or_create_by(descripcion: 'Medicina del Trabajo',estatus: 1)
    Especialidad.find_or_create_by(descripcion: 'Medicina del Deporte',estatus: 1)
    Especialidad.find_or_create_by(descripcion: 'Medicina Legal',estatus: 1)
    Especialidad.find_or_create_by(descripcion: 'Medicina Preventiva',estatus: 1)
    Especialidad.find_or_create_by(descripcion: 'Anestesiologia',estatus: 1)
    Especialidad.find_or_create_by(descripcion: 'Cardiologia',estatus: 1)
    Especialidad.find_or_create_by(descripcion: 'Dermatologia',estatus: 1)
    Especialidad.find_or_create_by(descripcion: 'Endocrinologia',estatus: 1)
    Especialidad.find_or_create_by(descripcion: 'Gastroenterologia',estatus: 1)
    Especialidad.find_or_create_by(descripcion: 'Ginecologia',estatus: 1)
    Especialidad.find_or_create_by(descripcion: 'Hematologia',estatus: 1)
    Especialidad.find_or_create_by(descripcion: 'Infectologia',estatus: 1)
    Especialidad.find_or_create_by(descripcion: 'Nefrologia',estatus: 1)
    Especialidad.find_or_create_by(descripcion: 'Neonatologia',estatus: 1)
    Especialidad.find_or_create_by(descripcion: 'Neurologia',estatus: 1)
    Especialidad.find_or_create_by(descripcion: 'Nutrilogia',estatus: 1)
    Especialidad.find_or_create_by(descripcion: 'Nemologia',estatus: 1)
    Especialidad.find_or_create_by(descripcion: 'Obstetricia',estatus: 1)
    Especialidad.find_or_create_by(descripcion: 'Oncologia',estatus: 1)
    Especialidad.find_or_create_by(descripcion: 'Pediatria',estatus: 1)
    Especialidad.find_or_create_by(descripcion: 'Rehumatologia',estatus: 1)
    Especialidad.find_or_create_by(descripcion: 'Toxicologia',estatus: 1)
    Especialidad.find_or_create_by(descripcion: 'Urologia',estatus: 1)
    ...
    Evaluacion.find_or_create_by(descripcion: '',estatus: 1)
    ...
    OptionMenu.find_or_create_by(:id_padre => nil, :nombre => 'Configuración General',     :url_path => '#', :icono => 'fa-cogs'       ,      :controlador => '', :accion => '', num_hijos: 3, :estatus => 'A')
      OptionMenu.find_or_create_by(:id_padre => 1,   :nombre => 'Datos de Servicios',                :url_path => '#', :icono => 'fa-edit',           :controlador => '', :accion => '', num_hijos: 9, :estatus => 'A')
              OptionMenu.find_or_create_by(:id_padre => 2, :nombre => 'Paises',                   :url_path => '#', :icono => '',             :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
              OptionMenu.find_or_create_by(:id_padre => 2, :nombre => 'Estados',                   :url_path => '#', :icono => '',             :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
              OptionMenu.find_or_create_by(:id_padre => 2, :nombre => 'Ciudades',                   :url_path => '#', :icono => '',             :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
              OptionMenu.find_or_create_by(:id_padre => 2, :nombre => 'Tipos de Ubicación',                   :url_path => '', :icono => '',             :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
              OptionMenu.find_or_create_by(:id_padre => 2, :nombre => 'Ubicaciónes',                   :url_path => '#', :icono => '',             :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
              OptionMenu.find_or_create_by(:id_padre => 2, :nombre => 'Especialidades',                   :url_path => '#', :icono => '',             :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
              OptionMenu.find_or_create_by(:id_padre => 2, :nombre => 'Tipos de Atención',                   :url_path => '#', :icono => '',             :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
              OptionMenu.find_or_create_by(:id_padre => 2, :nombre => 'Tipos de Servicio',                   :url_path => '#', :icono => '',             :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
              OptionMenu.find_or_create_by(:id_padre => 2, :nombre => 'Tipos de Evento',                   :url_path => '#', :icono => '',             :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
      OptionMenu.find_or_create_by(:id_padre => 1,   :nombre => 'Datos de Agendas y Citas',              :url_path => '#', :icono => 'fa-edit', :controlador => '', :accion => '', num_hijos: 14, :estatus => 'A')
              OptionMenu.find_or_create_by(:id_padre => 12, :nombre => 'Dias',                   :url_path => '#', :icono => '',             :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
              OptionMenu.find_or_create_by(:id_padre => 12, :nombre => 'Turnos',                   :url_path => '#', :icono => '',             :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
              OptionMenu.find_or_create_by(:id_padre => 12, :nombre => 'Bloques',                   :url_path => '#', :icono => '',             :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
              OptionMenu.find_or_create_by(:id_padre => 12, :nombre => 'Tipos de Horario',                   :url_path => '#', :icono => '',             :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
              OptionMenu.find_or_create_by(:id_padre => 12, :nombre => 'Tipos de Cita',                   :url_path => '#', :icono => '',             :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
              OptionMenu.find_or_create_by(:id_padre => 12, :nombre => 'Tipos de Pago',                   :url_path => '#', :icono => '',             :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
              OptionMenu.find_or_create_by(:id_padre => 12, :nombre => 'Tipos de Motivo',                   :url_path => '#', :icono => '',             :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
              OptionMenu.find_or_create_by(:id_padre => 12, :nombre => 'Motivos',                   :url_path => '#', :icono => '',             :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
              OptionMenu.find_or_create_by(:id_padre => 12, :nombre => 'Tipos de Eventualidad',                   :url_path => '#', :icono => '',             :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
              OptionMenu.find_or_create_by(:id_padre => 12, :nombre => 'Eventualidades',                   :url_path => '#', :icono => '',             :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
              OptionMenu.find_or_create_by(:id_padre => 12, :nombre => 'Tipos de Calificacio',                   :url_path => '#', :icono => '',             :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
              OptionMenu.find_or_create_by(:id_padre => 12, :nombre => 'Calificaciones',                   :url_path => '#', :icono => '',             :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
              OptionMenu.find_or_create_by(:id_padre => 12, :nombre => 'Tipos de Criterio',                   :url_path => '#', :icono => '',             :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
              OptionMenu.find_or_create_by(:id_padre => 12, :nombre => 'Criterios',                   :url_path => '#', :icono => '',             :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
      OptionMenu.find_or_create_by(:id_padre => 1,   :nombre => 'Datos de Segmentacion',                   :url_path => '#', :icono => 'fa-edit',          :controlador => '', :accion => '', num_hijos: 18, :estatus => 'A')
              OptionMenu.find_or_create_by(:id_padre => 27, :nombre => 'Sexos',                   :url_path => '#', :icono => '',             :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
              ...
              OptionMenu.find_or_create_by(:id_padre => 27, :nombre => 'Tipos de Lesion',                   :url_path => 'tipo_lesiones', :icono => '',             :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
              ...
              OptionMenu.find_or_create_by(:id_padre => 27, :nombre => 'Estados Civiles',                   :url_path => 'estado_civiles', :icono => '',             :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
              ...
              OptionMenu.find_or_create_by(:id_padre => 27, :nombre => 'Grupos Sanguíneos',                   :url_path => 'grupos_sanguineos', :icono => '',             :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
              OptionMenu.find_or_create_by(:id_padre => 27, :nombre => 'Tipos de Adiccion',                   :url_path => 'tipo_adicciones', :icono => '',             :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
    ...
    OptionMenu.find_or_create_by(:id_padre => nil, :nombre => 'Oferta y Eventos',          :url_path => '#', :icono => 'fa-calendar',         :controlador => '', :accion => '', num_hijos: 2, :estatus => 'A')
      ...
      OptionMenu.find_or_create_by(:id_padre => 46,   :nombre => 'Catalogo de Servicios',   :url_path => '#', :icono => 'fa-table',           :controlador => '', :accion => '', num_hijos: 2, :estatus => 'A')
        OptionMenu.find_or_create_by(:id_padre => 47,   :nombre => 'Servicios',             :url_path => '#', :icono => 'fa-flask',            :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
        OptionMenu.find_or_create_by(:id_padre => 47,   :nombre => 'Especialistas',         :url_path => '#', :icono => 'fa-user-md',          :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
      OptionMenu.find_or_create_by(:id_padre => 46,   :nombre => 'Catalogo de Eventos',     :url_path => '#', :icono => 'fa-table',            :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
    ...
    OptionMenu.find_or_create_by(:id_padre => nil,   :nombre => 'Agenda',                  :url_path => '#', :icono => 'fa-calendar',         :controlador => '', :accion => '', num_hijos: 3, :estatus => 'A')
      OptionMenu.find_or_create_by(:id_padre => 51,  :nombre => 'Gestionar',               :url_path => '#', :icono => 'fa-search',           :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
      OptionMenu.find_or_create_by(:id_padre => 51,  :nombre => 'Horarios',                :url_path => '#', :icono => 'fa-clock-o',          :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
      OptionMenu.find_or_create_by(:id_padre => 51,  :nombre => 'Eventualidades',          :url_path => '#', :icono => 'fa-exclamation-circle',           :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
  	...
  	OptionMenu.find_or_create_by(:id_padre => nil, :nombre => 'Citas',                     :url_path => '#', :icono => 'fa-stethoscope',      :controlador => '', :accion => '', num_hijos: 4, :estatus => 'A')
    	OptionMenu.find_or_create_by(:id_padre => 55,   :nombre => 'Generar',              :url_path => '#', :icono => 'fa-plus',           :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
      OptionMenu.find_or_create_by(:id_padre => 55,   :nombre => 'Gestionar',              :url_path => '#', :icono => 'fa-search',           :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')    	
    	OptionMenu.find_or_create_by(:id_padre => 55,   :nombre => 'Historial',              :url_path => '#', :icono => 'fa-history',          :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
      OptionMenu.find_or_create_by(:id_padre => 55,   :nombre => 'Eventualidades',         :url_path => '#', :icono => 'fa-exclamation-circle',           :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')  	
    ...
    OptionMenu.find_or_create_by(:id_padre => nil,   :nombre => 'Servicio Medico',    :url_path => '#', :icono => 'fa-hospital-o', :controlador => '', :accion => '', num_hijos: 3, :estatus => 'A')
      OptionMenu.find_or_create_by(:id_padre => 60,   :nombre => 'Registrar Paciente',    :url_path => '#', :icono => 'fa-id-card-o', :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
    	OptionMenu.find_or_create_by(:id_padre => 60,   :nombre => 'Evaluar Cita',    :url_path => '#', :icono => 'fa-star-half-full', :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
      OptionMenu.find_or_create_by(:id_padre => 60, :nombre => 'Consultar Pacientes',               :url_path => '#', :icono => 'fa-heartbeat',        :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
    ...
    OptionMenu.find_or_create_by(:id_padre => nil, :nombre => 'Reportes',                  :url_path => '#', :icono => 'fa-bar-chart',        :controlador => '', :accion => '', num_hijos: 3, :estatus => 'A')
      OptionMenu.find_or_create_by(:id_padre => 64, :nombre => 'Estructurados',                   :url_path => '#', :icono => '',             :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
      OptionMenu.find_or_create_by(:id_padre => 64, :nombre => 'No Estructurados',                   :url_path => '#', :icono => '',             :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')  
      OptionMenu.find_or_create_by(:id_padre => 64, :nombre => 'Estadisticos',                   :url_path => '#', :icono => '',             :controlador => '', :accion => '', num_hijos: 4, :estatus => 'A')  
        OptionMenu.find_or_create_by(:id_padre => 67,  :nombre => 'Satisfaccion del Paciente', :url_path => '#', :icono => 'fa-file-text-o',      :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
        OptionMenu.find_or_create_by(:id_padre => 67,  :nombre => 'Citas Concretadas',         :url_path => '#', :icono => 'fa-pie-chart',      :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
        OptionMenu.find_or_create_by(:id_padre => 67,  :nombre => 'Efectos de Difusion',       :url_path => '#', :icono => 'fa-file-text-o',      :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
        OptionMenu.find_or_create_by(:id_padre => 67,  :nombre => 'Eventualidades',            :url_path => '#', :icono => 'fa-file-text-o',      :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
    ...
    OptionMenu.find_or_create_by(:id_padre => nil, :nombre => 'Administracion',              :url_path => '#', :icono => 'fa-cog',              :controlador => '', :accion => '', num_hijos: 4, :estatus => 'A')
      OptionMenu.find_or_create_by(:id_padre => 72, :nombre => 'Sitio Web',              :url_path => '#', :icono => 'fa-cog',              :controlador => '', :accion => '', num_hijos: 3, :estatus => 'A')
  	    OptionMenu.find_or_create_by(:id_padre => 73,  :nombre => 'Contenido',                       :url_path => '#', :icono => 'fa-at',               :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
        OptionMenu.find_or_create_by(:id_padre => 73,  :nombre => 'Imagenes',                  :url_path => '#', :icono => 'fa-desktop',          :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
  	    OptionMenu.find_or_create_by(:id_padre => 73,  :nombre => 'Noticias',                  :url_path => '#', :icono => 'newspaper',          :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
      OptionMenu.find_or_create_by(:id_padre => 72, :nombre => 'Seguridad Funcional',                   :url_path => '#', :icono => 'fa-users',             :controlador => '', :accion => '', num_hijos: 3, :estatus => 'A')
        OptionMenu.find_or_create_by(:id_padre => 77, :nombre => 'Usuarios',               :url_path => '#', :icono => 'fa-user-plus',        :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
        OptionMenu.find_or_create_by(:id_padre => 77, :nombre => 'Roles',                      :url_path => '#', :icono => 'fa-bookmark-o',        :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
        OptionMenu.find_or_create_by(:id_padre => 77, :nombre => 'Permisos',                   :url_path => '#', :icono => 'fa-check',            :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
    ...
    Universidad.find_or_create_by(:descripcion => 'Universidad Rafael Belloso Chacin - URBE', :estatus => 1)
    Universidad.find_or_create_by(:descripcion => 'Universidad de los Andes - ULA', :estatus => 1)
    Universidad.find_or_create_by(:descripcion => 'UNES', :estatus => 1)
    Universidad.find_or_create_by(:descripcion => 'Universidad Nacional Experimental de los Llanos Occidentales Ezequiel Zamora', :estatus => 1)
    Universidad.find_or_create_by(:descripcion => 'Universidad del Zulia', :estatus => 1)
    Universidad.find_or_create_by(:descripcion => 'Universidad Catolica Andres Bello - UCAB', :estatus => 1)
    Universidad.find_or_create_by(:descripcion => 'Universidad Bicentenaria de Aragua', :estatus => 1)
    Universidad.find_or_create_by(:descripcion => 'Universidad Nacional Experimental del Tachira - UNET', :estatus => 1)
    Universidad.find_or_create_by(:descripcion => 'Universidad Bolivariana de Venezuela', :estatus => 1)
    Universidad.find_or_create_by(:descripcion => 'Universidad de Carabobo', :estatus => 1)
    Universidad.find_or_create_by(:descripcion => 'Universidad Simon Bolivar - USB', :estatus => 1)
    Universidad.find_or_create_by(:descripcion => 'Universidad Nacional Experimental de Guayana', :estatus => 1)
    Universidad.find_or_create_by(:descripcion => 'Universidad Jose Antonio Paez', :estatus => 1)
    Universidad.find_or_create_by(:descripcion => 'Universidad de Oriente', :estatus => 1)
    Universidad.find_or_create_by(:descripcion => 'Universidad Santa Maria - USM', :estatus => 1)
    Universidad.find_or_create_by(:descripcion => 'Universidad Metropolitana', :estatus => 1)
    Universidad.find_or_create_by(:descripcion => 'Universidad Nacional Experimental Romulo Gallegos', :estatus => 1)
    Universidad.find_or_create_by(:descripcion => 'Universidad de Falcon', :estatus => 1)
    Universidad.find_or_create_by(:descripcion => 'Universidad Rafael Urdaneta', :estatus => 1)
    Universidad.find_or_create_by(:descripcion => 'Instituto Universitario Politecnico Santiago Marino', :estatus => 1)
    Universidad.find_or_create_by(:descripcion => 'Universidad Valle del Monboy', :estatus => 1)
    Universidad.find_or_create_by(:descripcion => 'Universidad Nacional Abierta', :estatus => 1)
    Universidad.find_or_create_by(:descripcion => 'Instituto de Estudios Superiores de Administracion', :estatus => 1)
    Universidad.find_or_create_by(:descripcion => 'Universidad Nacional Experimental Politecnica', :estatus => 1)
    Universidad.find_or_create_by(:descripcion => 'Universidad Alejandro de Humbold', :estatus => 1)
    Universidad.find_or_create_by(:descripcion => 'Universidad Jose Maria Vargas', :estatus => 1)
    Universidad.find_or_create_by(:descripcion => 'Universidad Tecnologica del Centro', :estatus => 1)
    Universidad.find_or_create_by(:descripcion => 'Universidad Arturo Michelena', :estatus => 1)
    Universidad.find_or_create_by(:descripcion => 'Universidad Monteavila', :estatus => 1)
    Universidad.find_or_create_by(:descripcion => 'Universidad Gran Mariscal de Ayacucho - UGMA', :estatus => 1)
    Universidad.find_or_create_by(:descripcion => 'Universidad Nueva Esparta', :estatus => 1)
    Universidad.find_or_create_by(:descripcion => 'Universidad Alonso de Ojeda', :estatus => 1)
    Universidad.find_or_create_by(:descripcion => 'Universidad Catolica Cecilio Acosta', :estatus => 1)
    Universidad.find_or_create_by(:descripcion => 'Universidad Nacional Experimental Rafel Maria Baralt', :estatus => 1)
    Universidad.find_or_create_by(:descripcion => 'Colegio Universitario Monsenor de Talavera', :estatus => 1)
    Universidad.find_or_create_by(:descripcion => 'Universidad de Oriente Nucleo Bolivar', :estatus => 1)
    Universidad.find_or_create_by(:descripcion => 'Instituto Universitario de Tecnologia Jose Antonio Anzoategui', :estatus => 1)
    Universidad.find_or_create_by(:descripcion => 'IUNAV', :estatus => 1)
    Universidad.find_or_create_by(:descripcion => 'Universidad Dr. Jose Gregorio Hernandez', :estatus => 1)
    Universidad.find_or_create_by(:descripcion => 'Universidad Nacional Experimental Simon Rodriguez', :estatus => 1)
    Universidad.find_or_create_by(:descripcion => 'Universidad Nacional Experimental Francisco Miranda', :estatus => 1)
    Universidad.find_or_create_by(:descripcion => 'Universidad Panamericana del Puerto', :estatus => 1)
    Universidad.find_or_create_by(:descripcion => 'Universidad de Margarita', :estatus => 1)
    Universidad.find_or_create_by(:descripcion => 'Universidad Yacambu', :estatus => 1)
    Universidad.find_or_create_by(:descripcion => 'Colegio San Antonio', :estatus => 1)
    Universidad.find_or_create_by(:descripcion => 'Universidad Indigena de Venezuela', :estatus => 1)
    Universidad.find_or_create_by(:descripcion => 'Centro de Ecologia', :estatus => 1)
    Universidad.find_or_create_by(:descripcion => 'Universidad Pedagogica Experimental Libertador', :estatus => 1)
    NivelFormacion.find_or_create_by(:descripcion => 'Bachillerato', :estatus => 1)
    NivelFormacion.find_or_create_by(:descripcion => 'Tecnico Medio', :estatus => 1)
    NivelFormacion.find_or_create_by(:descripcion => 'Tecnico Superior', :estatus => 1)
    ...
    FormacionAcademica.find_or_create_by(:descripcion => 'Maestria mencion salud mental publica', :estatus => 1, :nivel_formacion_id => NivelFormacion.find(4))
    FormacionAcademica.find_or_create_by(:descripcion => 'Doctorado mencion Epidemiologia Clinica', :estatus => 1, :nivel_formacion_id => NivelFormacion.find(4))
