...
#   Tipo Horario linea 390 falta agregar con los cambios que tiene marcos
    ...
    OptionMenu.find_or_create_by(:id_padre => nil,   :nombre => 'Agenda',                  :url_path => '#', :icono => 'fa-calendar',         :controlador => '', :accion => '', num_hijos: 3, :estatus => 'A')
  	...
  	OptionMenu.find_or_create_by(:id_padre => nil, :nombre => 'Citas',                     :url_path => '#', :icono => 'fa-stethoscope',      :controlador => '', :accion => '', num_hijos: 4, :estatus => 'A')
        OptionMenu.find_or_create_by(:id_padre => 60,   :nombre => 'Mis Citas',              :url_path => '/citas', :icono => 'fa-search',           :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
    	OptionMenu.find_or_create_by(:id_padre => 60,   :nombre => 'Historial',              :url_path => '/historial_cita', :icono => 'fa-history',          :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
    ...
    OptionMenu.find_or_create_by(:id_padre => nil,   :nombre => 'Servicios Médicos',    :url_path => '#', :icono => 'fa-hospital-o', :controlador => '', :accion => '', num_hijos: 3, :estatus => 'A')
        OptionMenu.find_or_create_by(:id_padre => 63,   :nombre => 'Confirmar Cita',    :url_path => '/chequear_cita', :icono => 'fa-id-card-o', :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
    	OptionMenu.find_or_create_by(:id_padre => 63,   :nombre => 'Atender Cita',    :url_path => '/finalizar_cita', :icono => 'fa-id-card-o', :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
    ...
    OptionMenu.find_or_create_by(:id_padre => nil, :nombre => 'Reportes Estadísticos',   :url_path => '#', :icono => 'fa-bar-chart',        :controlador => '', :accion => '', num_hijos: 12, :estatus => 'A')
	    OptionMenu.find_or_create_by(:id_padre => 67, :nombre => 'Gestión de citas',                   :url_path => '/grafico/citas_solicitadas', :icono => '',             :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
	    OptionMenu.find_or_create_by(:id_padre => 67, :nombre => 'Gestión de Citas por Turno',                   :url_path => '/grafico/citas_por_turno', :icono => '',             :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
        ...
        OptionMenu.find_or_create_by(:id_padre => 67, :nombre => 'Satisfacción de pacientes',                   :url_path => '/grafico/satisfaccion_pacientes', :icono => '',             :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
	...
	OptionMenu.find_or_create_by(:id_padre => nil, :nombre => 'Difusión y Escucha al Cliente',              :url_path => '#', :icono => 'fa-cog',              :controlador => '', :accion => '', num_hijos: 3, :estatus => 'A')
		...
		OptionMenu.find_or_create_by(:id_padre => 80, :nombre => 'Atender opiniones',              :url_path => '/opiniones', :icono => 'fa-cog',              :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
    ...
    OptionMenu.find_or_create_by(:id_padre => nil, :nombre => 'Administración',              :url_path => '#', :icono => 'fa-cog',              :controlador => '', :accion => '', num_hijos: 4, :estatus => 'A')
        ...
        OptionMenu.find_or_create_by(:id_padre => 83, :nombre => 'Sitio Web',              :url_path => '#', :icono => 'fa-cog',              :controlador => '', :accion => '', num_hijos: 6, :estatus => 'A')
	  	    OptionMenu.find_or_create_by(:id_padre => 89,  :nombre => 'Organización',                       :url_path => '/informacion_generals', :icono => 'fa-at',               :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
	        OptionMenu.find_or_create_by(:id_padre => 89,  :nombre => 'Tipos de Noticia',                  :url_path => '/tipo_noticias', :icono => 'newspaper',          :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
	        OptionMenu.find_or_create_by(:id_padre => 89,  :nombre => 'Noticias',                  :url_path => '/noticias', :icono => 'newspaper',          :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
	  	    OptionMenu.find_or_create_by(:id_padre => 89,  :nombre => 'Tipos de Pregunta',                  :url_path => '/tipo_preguntas', :icono => 'newspaper',          :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
	  	    OptionMenu.find_or_create_by(:id_padre => 89,  :nombre => 'Preguntas',                  :url_path => '/preguntas', :icono => 'newspaper',          :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
	        OptionMenu.find_or_create_by(:id_padre => 89, :nombre => 'Tipos de Opinión',                   :url_path => '/tipo_opiniones', :icono => '',             :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
		OptionMenu.find_or_create_by(:id_padre => 83, :nombre => 'Seguridad Funcional',                   :url_path => '#', :icono => 'fa-users',             :controlador => '', :accion => '', num_hijos: 2, :estatus => 'A')
	        OptionMenu.find_or_create_by(:id_padre => 96, :nombre => 'Usuarios',               :url_path => '/usuarios', :icono => 'fa-user-plus',        :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
	        OptionMenu.find_or_create_by(:id_padre => 96, :nombre => 'Roles',                      :url_path => '/roles', :icono => 'fa-bookmark-o',        :controlador => '', :accion => '', num_hijos: 0, :estatus => 'A')
