...
#   Tipo Horario linea 390 falta agregar con los cambios que tiene marcos
    ...
    Servicio.find_or_create_by(descripcion: 'Consulta dermatologica para quemadura', :ubicacion => Ubicacion.find(2), :tipo_servicio => TipoServicio.find(3), :especialista => Especialista.find(1), :estatus => 1, foto_file_name: nil, foto_content_type: nil, foto_file_size: nil, foto_updated_at: nil, precio: 25000)
