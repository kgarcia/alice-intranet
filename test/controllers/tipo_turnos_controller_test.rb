...
class TipoTurnosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tipo_turno" do
    assert_difference('TipoTurno.count') do
      post tipo_turnos_url, params: { tipo_turno: { descripcion: @tipo_turno.descripcion, estatus: @tipo_turno.estatus } }
    end
  ...
  test "should update tipo_turno" do
    patch tipo_turno_url(@tipo_turno), params: { tipo_turno: { descripcion: @tipo_turno.descripcion, estatus: @tipo_turno.estatus } }
