...
class RangoEdadsControllerTest < ActionDispatch::IntegrationTest
  setup do
    @rango_edad = rango_edads(:one)
  end
  ...
  test "should create rango_edad" do
    assert_difference('RangoEdad.count') do
      post rango_edads_url, params: { rango_edad: { descripcion: @rango_edad.descripcion, edad_final: @rango_edad.edad_final, edad_inicial: @rango_edad.edad_inicial, estatus: @rango_edad.estatus } }
    end
  ...
  test "should destroy rango_edad" do
    ...
    assert_redirected_to rango_edads_url
  end
end
