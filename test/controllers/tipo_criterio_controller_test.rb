...
class TipoCriterioControllerTest < ActionDispatch::IntegrationTest
  setup do
    @tipo_criterio = tipo_criterio(:one)
  end

  test "should get index" do
    get tipo_criterio_index_url
  ...
  test "should create tipo_criterio" do
    assert_difference('TipoCriterio.count') do
      post tipo_criterio_index_url, params: { tipo_criterio: { descripcion: @tipo_criterio.descripcion, estatus: @tipo_criterio.estatus } }
    end
  ...
  test "should destroy tipo_criterio" do
    ...
    assert_redirected_to tipo_criterio_index_url
  end
end
