...
class EventosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create evento" do
    assert_difference('Evento.count') do
      post eventos_url, params: { evento: { descripcion: @evento.descripcion, estatus: @evento.estatus, tipo_evento_id: @evento.tipo_evento_id } }
    end
  ...
  test "should update evento" do
    patch evento_url(@evento), params: { evento: { descripcion: @evento.descripcion, estatus: @evento.estatus, tipo_evento_id: @evento.tipo_evento_id } }
