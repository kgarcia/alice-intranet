...
class HorariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create horario" do
    assert_difference('Horario.count') do
      post horarios_url, params: { horario: { descripcion: @horario.descripcion, tipo_horario_id: @horario.tipo_horario_id } }
    end
  ...
  test "should update horario" do
    patch horario_url(@horario), params: { horario: { descripcion: @horario.descripcion, tipo_horario_id: @horario.tipo_horario_id } }
